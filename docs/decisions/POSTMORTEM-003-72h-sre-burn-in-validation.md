...
在歷經 [POSTMORTEM-002](docs/decisions/POSTMORTEM-002-io-blocking-and-kthread-migration.md) 的上下文重構與 [ADR-006](docs/decisions/ADR-006-domain-decoupling-and-transition-to-infrastructure-stack.md) 的 IT/OT 本質性解耦後，V5.0 系統已具備微秒級的硬即時防禦能力。然而，作為工業邊緣閘道器 (Edge Gateway)，系統必須具備長效無人值守 (Zero-touch) 的穩定性。
